...
<g class="animate-delay-[var(--d)] animate-duration-500 animate-ease-in-out animate-name-float group opacity-[var(--o)] pointer-events-[var(--p)] translate-y-[var(--t)]" on:animationend|once={animation_end} style:--d="{delay}s" style:--o={animation ? '0' : '1'} style:--p={animation ? 'none' : 'unset'} style:--t={animation ? '-3rem' : '0'}>
